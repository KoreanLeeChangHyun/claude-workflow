...
from _utils.common import resolve_project_root, load_json_file, resolve_work_dir, TS_PATTERN
...
def main():
    ...
    # .claude.env에서 설정 로드
    guard_transition = os.environ.get("GUARD_WORKFLOW_TRANSITION") or read_env("GUARD_WORKFLOW_TRANSITION")
    ...
    fsm_file = os.path.join(project_root, ".claude", "scripts", "workflow", "fsm-transitions.json")
