...
cmd_setup_wf_alias() {
  ...
  local alias_cmds=(
    "bash .claude/scripts/workflow/banner.sh"
    "bash .claude/scripts/workflow/update-state.sh"
    "bash .claude/scripts/init/init-workflow.sh"
    "bash .claude/scripts/init/init-claude.sh"
    "bash .claude/scripts/init/init-project.sh"
    "bash .claude/scripts/init/init-clear.sh"
    "bash .claude/scripts/workflow/registry.sh"
    "bash .claude/scripts/init/init-sync.sh"
    "bash .claude/scripts/init/git-config.sh"
    "bash .claude/scripts/slack/slack.sh"
    "bash .claude/scripts/workflow/info.sh"
    "bash .claude/scripts/workflow/commands.sh"
    "bash .claude/scripts/workflow/history-sync.sh"
  )
