...
| 스킬 | 용도 | 경로 |
|------|------|------|
| research-deep | context:fork를 사용한 격리 환경에서 코드베이스 심층 탐색 | `.claude/skills/research-deep/SKILL.md` |
