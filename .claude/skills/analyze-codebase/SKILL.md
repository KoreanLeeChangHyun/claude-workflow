...
> **관련 스킬:** 상세한 코드 품질 검사(린트/타입체크 자동 실행, DRY/KISS/YAGNI 원칙 위반 탐지, 정량적 Code Quality Score 산출)는 `review-code-quality` 스킬을 참조하세요. (`/.claude/skills/review-code-quality/SKILL.md`)
