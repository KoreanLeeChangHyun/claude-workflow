...
python .claude/skills/management-skill-integrator/scripts/skill_auto_integrate.py "PDF 처리 스킬"

# 검색+변환만 수행 (설치 미실행)
python .claude/skills/management-skill-integrator/scripts/skill_auto_integrate.py --dry-run "코드 리뷰 스킬"

# 설치 경로 변경
python .claude/skills/management-skill-integrator/scripts/skill_auto_integrate.py --target /path/to/skills "데이터 분석 스킬"
```
