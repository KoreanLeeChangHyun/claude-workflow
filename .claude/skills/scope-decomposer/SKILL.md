...
description: "요청을 에픽/스토리로 자동 분해하고 RICE 우선순위를 판단하는 스킬. 대규모 요청을 구조화된 작업 단위로 분해. 사용 시점: 대규모 기능 요청, 프로젝트 스코프 정의, 요구사항 분해, 우선순위 판단 필요 시. 트리거: '분해', 'decompose', '에픽', 'epic', '스토리', 'story', '우선순위', 'priority', 'RICE', '스코프'."
---
