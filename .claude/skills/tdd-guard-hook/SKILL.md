...
**경로**: `.claude/hooks/pre-tool-use/tdd-guard.py` (thin wrapper -> `.claude/scripts/guards/tdd_guard.py`)
...
- Hook 스크립트: `.claude/hooks/pre-tool-use/tdd-guard.py` (thin wrapper -> `.claude/scripts/guards/tdd_guard.py`)
