...
**경로**: `.claude/hooks/pre-tool-use/devops-dangerous-guard.py` (thin wrapper -> `.claude/scripts/guards/dangerous_command_guard.py`)
...
- Hook 스크립트: `.claude/hooks/pre-tool-use/devops-dangerous-guard.py` (thin wrapper -> `.claude/scripts/guards/dangerous_command_guard.py`)
