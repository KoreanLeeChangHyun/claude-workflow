...
## workflow-system 및 devops-github과의 역할 분리

| 항목 | workflow-system | devops-github | review-pr-integration |
|------|-----------|-------------------|----------------------|
...
**보완 관계:** workflow-system으로 PR을 생성한 뒤, review-pr-integration으로 해당 PR을 리뷰한다. devops-github은 두 스킬 모두에서 gh CLI 실행의 기반이 된다.
...
| 스킬 | 경로 | 관계 |
|------|------|------|
| workflow-system | `.claude/skills/workflow-system/reference/report-output.md` | PR 생성 시 제목/본문 생성 (작성자 관점) |
