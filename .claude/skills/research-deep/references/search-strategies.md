...
research-deep 스킬에서 코드베이스를 심층 탐색할 때 활용하는 도메인별 전략 가이드입니다. 각 전략은 Explore 에이전트의 읽기 전용 도구(Read, Grep, Glob)만을 사용합니다.
...
## research-general와의 통합 활용

research-deep의 코드베이스 탐색 결과를 research-general의 웹 조사와 결합하면 보다 완전한 연구가 가능합니다.

| 순서 | 스킬 | 활동 | 예시 |
|------|------|------|------|
| 1 | research-deep | 코드베이스에서 사용 중인 패턴/라이브러리 식별 | "이 프로젝트가 사용하는 인증 방식 파악" |
| 2 | research-general | 식별된 패턴/라이브러리의 최신 동향, 대안, 베스트 프랙티스 웹 조사 | "식별된 JWT 방식의 보안 이슈 및 대안 조사" |
