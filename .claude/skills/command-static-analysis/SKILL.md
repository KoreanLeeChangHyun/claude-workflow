...
| 영역 | code-quality-checker | command-static-analysis |
|------|---------------------|------------------------|
...
**상호 보완**: code-quality-checker가 기본 보안 이슈를 탐지하고, command-static-analysis가 심층 보안 검사를 수행. 두 스킬이 동시 로드되면 code-quality-checker의 SEC- 결과를 기반으로 심층 분석을 확장한다.
