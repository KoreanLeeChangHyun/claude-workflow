...
| research | 현황 요약, 배경 정보, 선행 연구 참조 | 현황 스냅샷 수치: 크기, 파일 수, 기간 등 (예: "총 2.3MB, 301개 파일, 36개 디렉토리, 기간 2일") |
| refactor | 개선 전 상태, 리팩토링 방향성 | 리팩토링 전 상태 수치: 코드 라인, 함수 수, 중복도 (예: "현재 800줄, 함수 20개, 중복 코드 3건") |
| architect | 제약 조건, 기존 아키텍처 요약 | 현행 구조 수치: 모듈 수, 의존성 수, 레이어 수 (예: "모듈 8개, 의존성 15개, 3-tier 구조") |
