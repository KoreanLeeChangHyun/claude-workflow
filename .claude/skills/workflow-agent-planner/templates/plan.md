...
<!-- goal 재서술 금지. 기술적 접근 방식(HOW)과 예상 산출물만 기술 -->
<!-- 사용자 의도(WHAT)는 user_prompt.txt가 전담. plan.md에서 goal을 반복하지 않음 -->
...
<!-- 스킬: 전문화 스킬 필수 1개+. 복수 스킬은 + 또는 , 로 구분. 프로젝트 스킬 존재 시 + 구분. 예: review-code-quality + project-domain, design-frontend, convention-front -->
