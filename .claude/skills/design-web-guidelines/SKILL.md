...
Accessibility and standards compliance technical checklist for web implementation. This skill focuses on **technical correctness and standards adherence** -- for visual design quality and aesthetic judgment, see `design-frontend`.

## Role Separation

| Skill | Scope |
|-------|-------|
| `design-frontend` | Design quality, aesthetics, typography, color, motion, spatial composition |
| `design-web-guidelines` | Accessibility compliance, standards checklists, technical correctness |

Apply both when building user-facing web interfaces: `design-frontend` for how it looks, this skill for how it works for all users.
