...
목적 선택 메뉴를 텍스트로 출력합니다:

```
**`[PROMPT]`**`[SINGLE]` 어떤 목적의 프롬프트를 작성할까요?

1. [research] 연구 — 기술 조사, 비교 분석, 자료 수집 요청
2. [implement] 구현 — 새 기능, 모듈, 함수 구현 요청
3. [implement] 버그수정 — 버그 원인 파악 및 수정 요청
4. [implement] 리팩토링 — 코드 구조 개선, 정리, 분리 요청
5. [implement] 아키텍처설계 — 시스템 설계, 구조 결정 요청
6. [review] 리뷰 — 코드 리뷰, 품질 검토 요청
