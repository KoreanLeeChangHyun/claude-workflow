---
description: "자유 대화형 프롬프트 공동 작성. 대화를 통해 prompt를 점진적으로 작성/개선합니다. Use when: 프롬프트 작성, 프롬프트 개선, 요청문 구조화, 지시문 작성 / Do not use when: 코드 구현, 리뷰, 조사가 목적일 때 (cc:implement, cc:review, cc:research 사용)"
argument-hint: "프롬프트 주제 또는 개선할 내용"
skills:
