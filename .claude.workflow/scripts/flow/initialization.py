...
def init_workflow(
    ...
    work_dir: str = f".claude.workflow/workflow/{registry_key}/{work_name}/{command}"
    ...
    if os.path.exists(abs_work_dir):
        for suffix in range(1, 100):
            ...
            candidate_dir: str = f".claude.workflow/workflow/{candidate_key}/{work_name}/{command}"
    ...
    workflow_root: str = os.path.join(_PROJECT_ROOT, ".claude.workflow", "workflow")
