...
사용법:
  python3 .claude.workflow/scripts/flow/skill_mapper.py <registryKey>
...
def _update_skills_md(registry_key: str, command: str, tasks: list, all_resolved: list, token_budget: int) -> None:
    ...
    try:
        ...
        # skill-map.md 링크: .claude.workflow/dashboard/에서 ../.claude.workflow/workflow/{timestamp}/{workName}/{command}/work/skill-map.md
        try:
