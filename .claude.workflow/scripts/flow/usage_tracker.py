...
def usage_regenerate() -> str:
    """.claude.workflow/workflow/ 및 .claude.workflow/workflow/.history/ 하위의 모든 usage.json을 순회하여 .claude.workflow/dashboard/.usage.md를 재생성한다.
    ...
    try:
        ...
        workflow_base = os.path.join(PROJECT_ROOT, ".claude.workflow", "workflow")
