...
주요 함수:
    load_slack_env: .claude.workflow/.env에서 SLACK_BOT_TOKEN, SLACK_CHANNEL_ID 로드
...
from data.constants import SLACK_API_URL, SLACK_EMOJI_MAP
...
def load_slack_env(env_file: str | None = None) -> bool:
    """
    .claude.workflow/.env에서 Slack 환경변수 로드.
