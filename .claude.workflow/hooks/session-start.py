...
또한 CLAUDE_ENV_FILE 메커니즘을 통해 Bash tool 환경에 .claude.workflow/bin
...
def main() -> None:
    ...
    1. CLAUDE_ENV_FILE에 .claude.workflow/bin PATH export를 작성하여
    ...
    # ensure_bin_path.sh는 CLAUDE_ENV_FILE에 .claude.workflow/bin PATH export를 추가한다.
