...
def _update_skill_frequency() -> None:
    ...
    """
    try:
        skills_md = os.path.join(PROJECT_ROOT, ".claude-organic", "dashboard", ".skills.md")
        lock_dir = os.path.join(PROJECT_ROOT, ".claude-organic", "dashboard", ".skills.md.lock")
...
def _update_logs_md(registry_key: str, abs_work_dir: str) -> None:
    ...
    try:
        ...
        logs_md = os.path.join(PROJECT_ROOT, ".claude-organic", "dashboard", ".logs.md")
        lock_dir = os.path.join(PROJECT_ROOT, ".claude-organic", "dashboard", ".logs.md.lock")
        ...
        try:
            rel_work_dir = os.path.relpath(abs_work_dir, os.path.join(PROJECT_ROOT, ".claude-organic", "dashboard"))
...
def _update_step_durations() -> None:
    ...
    try:
        ...
        history_md = os.path.join(PROJECT_ROOT, ".claude-organic", "dashboard", ".history.md")
        lock_dir = os.path.join(PROJECT_ROOT, ".claude-organic", "dashboard", ".history.md.lock")

        wf_base = os.path.join(PROJECT_ROOT, ".claude-organic", "workflow")
...
def _build_result_update_args(abs_work_dir: str) -> list[str]:
    ...
    # 상대 workDir: .claude-organic/workflow/{registryKey}/... 이후 부분을 포함한 경로
