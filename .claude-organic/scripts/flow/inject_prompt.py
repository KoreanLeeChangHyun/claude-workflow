...
.claude-organic/prompt/system-prompt-wf.xml을 stdout으로 출력한다.
...
동작:
  ...
  - 윈도우 이름이 P:T- 접두사로 시작하면 .claude-organic/prompt/system-prompt-wf.xml을 출력한다.
...
def main() -> None:
    ...
    prompt_file = os.path.join(project_root, ".claude-organic", "prompt", "system-prompt-wf.xml")
