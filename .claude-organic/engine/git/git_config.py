...
.claude-organic/.settings에서 Git 설정 정보를 읽어 git config를 자동으로 설정합니다.
...
_CW_DIR = os.path.join(_PROJECT_ROOT, ".claude-organic")
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        prog="flow-gitconfig",
        description=(
            ".claude-organic/.settings에서 Git 설정 정보를 읽어 "
...
def main() -> None:
    ...
    .claude-organic/.settings에서 환경변수를 읽어 git user.name, user.email,
