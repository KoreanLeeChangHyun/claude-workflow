...
function projectRoot() {
  ...
  var idx = path.indexOf(".claude-organic/board/");
  if (idx !== -1) return path.substring(0, idx);
  return "/";
}

/**
 * Builds a full URL path from a .claude-organic/ relative path.
 * @param {string} wfPath - Path starting with .claude-organic/ or workflow/
